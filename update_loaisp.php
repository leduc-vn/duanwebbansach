...
<body>
  <?php 
    ...
    if (!$sanpham) {
        echo '<div class="alert alert-danger">Không tìm thấy loại sản phẩm</div>';
        exit();
    }
  ...
  <div class="main">
    <div class="page-header">
      <h1>✏️ Cập nhật loại sản phẩm</h1>
      <p>Chỉnh sửa thông tin loại sản phẩm: <?php echo htmlspecialchars($txt_tenloaisp); ?></p>
    </div>
          ...
          <div class="form-grid">
            ...
            <div class="form-group full-width">
              ...
              <textarea name="txt_motaloaisp" id="txt_motaloaisp" 
                        class="form-control" rows="4"><?php echo htmlspecialchars($txt_motaloaisp); ?></textarea>
            </div>
          </div>
          
          <div class="form-actions">
            <a href="dongsp.php" class="btn btn-secondary">← Quay lại</a>
            <button type="submit" name="btn_update" class="btn btn-primary">💾 Cập nhật loại sản phẩm</button>
          </div>
        </form>
      </div>
    </div>
